...
dividi:
  ...
  divl  %ebx      # divide per ebx (10) il numero ottenuto concatenando
                  # il contenuto di edx e eax (notare che 
                  # in questo caso edx=0)
...
stampa:
  ...
  pushw %bx       # salviamo il valore di bx nello stack poiche'
  ...
  leal  car, %ecx # il puntatore della stringa da stampare deve
                  ...
                  # l'istruzione lea carica l'indirizzo della locazione
                  # di memoria indicata dalla etichetta car, nel 
                  # registro ecx
  ...
  pop   %bx       # recupera il contatore dei caratteri da stampare
...
fine_itoa:
  movb  $10, car  # copia nella variabile car il codice ascii del
